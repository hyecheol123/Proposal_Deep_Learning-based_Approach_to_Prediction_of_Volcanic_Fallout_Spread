...
\title{Deep Learning-based Approach \linebreak%
       to Prediction of Volcanic Fallut Spread
      }
...
\begin{abstract}
  \fontsize{11pt}{11pt} \selectfont {
    ...
    calculation is complicated and requires huge computing resources to make accurate prediction. 
    Previously, researchers figured out several ways to predict it faster, but still it required to 
    ...
    project, we plan to present a paper at a conference as weel as open-source our trained model so 
    that the whole society can be well prepared form the fatal disaster by getting the accurate 
    prediction faster.
  }
\end{abstract}
...
\fontsize{11pt}{11pt} \selectfont {
  ...
  be able to illustrate the region of disperse accurately.
  ...
  \fontsize{10pt}{10.5pt} \selectfont{
    \begin{figure}
      ...
      \caption{\textbf{Overview of the Research Goal}
                This research aims to make a deep-learning model predicting volcaninc fallout 
...
\fontsize{11pt}{11pt} \selectfont {
  ...
  The detailed timeline is on \textbf{Table \ref{table1}}.
