...
\fontsize{11pt}{11pt} \selectfont {
  ...
  Historically, by using the Eulerian or the Lagrangian approach, according to
  ~\citet[p.3-4]{Bonadonna2012}, scientists tried to make Volcanic Ash and Dispersion/Tracking 
  Model (VATDM). These models usually focused on predicting the pathway of fallout ash dispersion 
  and the amount of deposited ash while accepting limited variables~\citep[p.276]{Yun_2013}.
