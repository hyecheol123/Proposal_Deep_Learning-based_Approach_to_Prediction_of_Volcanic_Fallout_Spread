...
\fontsize{11pt}{11pt} \selectfont {
  ...
  Portal” operated by the Korea Meteorological Administration (KMA)~\citep[from][]{MDOP}. To get the
  ...
  Eruption), and VEI 7 (Massive Explosive Eruption)~\citep[p.1232]{Newhall1982}. The weather 
  prediction data, will be obtained by the same location where we found the weather maps: download 
  prediction made by RDAPS(regional data assimilation and prediction system)~\citep[from][]{MDOP}. 
